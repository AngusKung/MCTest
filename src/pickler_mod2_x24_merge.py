...
#"../Data/mc500.val.txt"
#"../Data/mc160.val.txt"
dataPickle_name = "../Pickle/"+txtFilename.split('/')[-1].split('.')[0]+"."+txtFilename.split('/')[-1].split('.')[1]+".mod2.x24.merge.pickle"
...
for one in txtList:
	...
	data.append( [ oneQ[:11]+[pair[0][0]]+[pair[1][0]]+[pair[2][0]]+[pair[3][0]], np.asarray( [pair[0][1],pair[1][1],pair[2][1],pair[3][1]]) ] )
    idxCounter += 1
pdb.set_trace()
print "Pickling..."

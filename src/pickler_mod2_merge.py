...
#"../Data/mc500.val.txt"
#"../Data/mc160.val.txt"
dataPickle_name = "../Pickle/"+txtFilename.split('/')[-1].split('.')[0]+"."+txtFilename.split('/')[-1].split('.')[1]+".mod2.merge.pickle"
...
for one in txtList:
    ...
    data.append( [ oneQ, np.asarray( ans[idxCounter],dtype='float32') ] )
    idxCounter += 1
pdb.set_trace()
print "Pickling..."
